...
\begin{document}
	...
	The function takes two parameters, the first is a vector values reprensenting the translation or the rotation of each axe. The is the type of representation we are in. It can be \lq\lq{}ZYZ\rq\rq{} or \lq\lq{}RPY\rq\rq{}.
	\begin{figure}[h]
	\center
	...
	The notions aboarded  are roto-translation matrices, 
