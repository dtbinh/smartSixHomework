...
\begin{document}
	...
	We also need a vector that we will call $a$ that stores the distances between the different axes. We get this values in on the figure 4 of the documentation of the project.\\
	\newpage
